        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="flex items-center gap-2 text-green-400 hover:drop-shadow-lg">
                <span>
                  <GoDotFill />
                </span>
                <span>Budget</span>
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="p-1.5 hover:drop-shadow-lg cursor-pointer rounded-full text-white bg-green-400 mr-3 text-xs">
                    23%
                  </span>
                </p>
